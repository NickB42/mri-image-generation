...
class UNet(nn.Module):
    """
    Time-conditioned U-Net for the memmap-based 2.5D DDPM.

    Default channel counts are for 1-channel FLAIR with slice_radius=2:
      in_channels  = 1 (target) + 1*2 (context) = 3
      out_channels = 1
    """
