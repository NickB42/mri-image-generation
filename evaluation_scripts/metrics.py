...
def main() -> None:
    ...
    ap.add_argument("--timesteps", type=int, default=None, help="If None, inferred from checkpoint betas length.")
    ap.add_argument("--batch_size", type=int, default=16)
    ap.add_argument("--num_workers", type=int, default=4)
    ap.add_argument("--num_samples", type=int, default=2000, help="How many real samples to compare (and how many generated).")
    ap.add_argument("--test_frac", type=float, default=0.15, help="Volume-level test split fraction.")
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--device", type=str, default=None)

    ap.add_argument("--z_bins", type=int, default=8)
    ap.add_argument("--diversity_pairs", type=int, default=128, help="How many (gen1,gen2) pairs for MS-SSIM/LPIPS.")
    ap.add_argument("--save_samples", action="store_true")
    ap.add_argument("--out_dir", type=str, default="./eval_out")

    ap.add_argument("--compute_pr", action="store_true", help="Compute improved precision/recall (slower).")
    ap.add_argument("--pr_samples", type=int, default=1000, help="How many samples for PR (real & fake). Keep <= 2000 for speed.")
    args = ap.parse_args()
